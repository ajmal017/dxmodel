$(document).ready(function() {
  ...
  calc_enter_local_value = function(){
    $('#position_enter_local_value').val( $('#position_quantity').val() * $('#position_enter_price').val() );
  }
  ...
  $('#position_quantity, #position_enter_price').keyup( calc_enter_local_value );
  ...
  calc_exit_local_value = function(){
    $('#position_exit_local_value').val( $('#position_quantity').val() * $('#position_exit_price').val() );
  }
  ...
  $('#position_quantity, #position_exit_price').keyup( calc_exit_local_value );
